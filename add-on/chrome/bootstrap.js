    ...
    var LoopUI = {
      ...
      startBrowserSharing: function() {
        if (!this._listeningToTabSelect) {
          ...
          // Add this event to the parent gBrowser to avoid adding and removing it
          // for each individual tab's browsers.
      ...
      /**
       * Handles mousemove events from gBrowser and send a broadcast message with
       * all the data needed for sending link generator cursor position through the sdk.
       */
